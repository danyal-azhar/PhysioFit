...
import fyp.tensorflow.lite.examples.posenet.lib.BodyPart
import fyp.tensorflow.lite.examples.posenet.lib.Person
...
///////////////////////////////////////////////Right side bicepcurls/////////////////////////////////////////////////////////
          ...
          if(rightbiceprepscount+leftbiceprepscount >= 10){
            exercise=2;
            squatrepcount=0;
          }

      }//////exercise check bicep
...
//////////////////////////////////////////////////////diaplaying reps and exercise////////////////////////////////////////////\
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if(exercise % 2 !=0 ) {
          ...
          canvas.drawText(
            "Left Bicep Reps count:" + leftbiceprepscount,
            (15.0f * widthRatio),
            (243.0f * heightRatio),
            paint
          )
          canvas.drawText(
            "Right Bicep Reps count:" + rightbiceprepscount,
            (15.0f * widthRatio),
            (253.0f * heightRatio),
            paint
          )
      ...
      if(exercise % 2 ==0 ) {
        ...
        canvas.drawText(
          "Squat Reps count:" + squatrepcount,
          (15.0f * widthRatio),
          (243.0f * heightRatio),
          paint
        )
