...
import com.balychev.tripleimpact.domain.CountDownTimerWithPause;
import com.balychev.tripleimpact.domain.CurrentState;
import com.balychev.tripleimpact.domain.HistoryRecord;
import com.balychev.tripleimpact.domain.TrainingHelper;
import com.balychev.tripleimpact.domain.Workout;
...
public class WorkoutActivity extends Activity {
    ...
    private void startCount(){
        ...
        doneButton.setText(getString(com.balychev.tripleimpact.R.string.done));
        ...
        instructionsText.setText(String.format(getString(com.balychev.tripleimpact.R.string.workout_instructions), repetitionsCount, repetitionsCount, repetitionsCount));
        createCountsView();
    }
    ...
    private void startTimer(final int sec) {
        ...
        doneButton.setText(getString(com.balychev.tripleimpact.R.string.pause));
        ...
        instructionsText.setText(getString(com.balychev.tripleimpact.R.string.take_break_instructions));
